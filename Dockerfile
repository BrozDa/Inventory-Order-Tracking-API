...
WORKDIR /src
COPY ["src/Inventory-Order-Tracking.API/InventoryManagement.API.csproj", "src/Inventory-Order-Tracking.API/"]
RUN dotnet restore "./src/Inventory-Order-Tracking.API/InventoryManagement.API.csproj"
COPY . .
WORKDIR "/src/src/Inventory-Order-Tracking.API"
